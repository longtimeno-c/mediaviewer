...
removes every key on uninstall. PR 15's handlers are not written yet; their registration
and removal will sit beside those keys in `tools/package/mediaviewer.iss`.
