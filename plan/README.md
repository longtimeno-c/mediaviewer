...
hostable; macOS is Milestone F, a host of the same core, not a UI-only port
...
| [10-roadmap.md](10-roadmap.md) | Windows release at PR 8, Milestone F (Mac, PR 16–20), dual-track updates PR 9–15 and PR 26 Ingest on both platforms, each with a verify line |
