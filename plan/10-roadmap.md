...
**separate process**. Notarized Sparkle, Apple Silicon only. First install is a branded
drag-install `.dmg` with the GPL on mount — the Mac twin of the PR 8 wizard, not a `.pkg`
