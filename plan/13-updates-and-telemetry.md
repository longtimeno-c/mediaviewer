...
The planned exceptions are the **optional add-on packs** — local search
([17-local-ai-search.md](17-local-ai-search.md)) and Voice
([19-voice.md](19-voice.md)): separate downloads installed from Settings
