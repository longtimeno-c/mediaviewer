vcpkg_from_github(
    ...
    HEAD_REF master
    PATCHES
        # Colour conversion, black scaling, and the gamma copy are serial in
        # 0.22.2. OpenMP them. Pixels stay identical: per-pixel math is unchanged
        # and histogram bins are summed.
        openmp-color.patch
)
...
vcpkg_from_github(
    ...
    PATCHES
        ...
        fix-install.patch
        # Apple's LibRaw headers undefine LIBRAW_USE_OPENMP unless this is set.
        openmp-apple.patch
)
